...
public class Cover {
    ...
    private final SelenideElement UPLOAD_COVER = COVER_DROPDOWN.$x(".//input[@title='Загрузить новую']");
    ...
    private final static String MAKE_FORM_VISIBLE_JS = "document.getElementsByClassName(\"html5-upload-link\")[1].classList.remove(\"html5-upload-link\")";
